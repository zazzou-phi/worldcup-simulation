  ...
  return (
    <header className="header">
      ...
      <div className="header-actions">
        ...
        {!actualResultsMode && !masterMode && (
          <>
            {!publicMode && isGroupStagePhase(simulation.phase) && (
              <GroupSimulateMenu simulating={simulating} onSelect={onSimulateGroupGames} />
            )}
            {!publicMode && isKnockoutStagePhase(simulation.phase) && simulation.phase !== 'complete' && (
              <KnockoutSimulateMenu
                simulating={simulating}
                onSelect={onSimulateKnockoutsThrough}
              />
            )}
            {!publicMode && (
              <>
